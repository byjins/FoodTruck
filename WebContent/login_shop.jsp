...
<body>
	...
	<div class="container col-lg-6 col-md-8 col-sm-6 col-xs-4">
		...
		<div class="content">
			<form method="post" action="loginshop.do">
				<h3 style="text-align: center;">사 업 자 로 그 인 화 면</h3>
				<br>
				<div>
				...
				<br>
				<div>
					<input type="password" class="form-control" id="shop_pw"
						name="shop_pw" placeholder="비 밀 번 호" maxlength="20">
				</div>
