...
<body>
	...
	<div class="container col-lg-6 col-md-8 col-sm-6 col-xs-4">
		...
		<form name = "findid" method="POST" action="findId.do">
						<h3 style="text-align: center;">아이디 찾기</h3>
						<br>
						<div class = "input-group">
							<input type="text" class="form-control" id="name" name="name"  placeholder="이 름" maxlength="4">
						</div>
						<br>
						<div class="form-row">
						<div class="col-sm-12">
						...
						<br>
						 <input type="submit" class="btn btn-info form-control" value="아이디 찾기">
					</form>
		</div>
	</div>
